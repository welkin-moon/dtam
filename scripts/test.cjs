...
includes(html,'/hybrid-transport.js?v=20260918-v302session4','current transport entry must be loaded');
...
includes(hybrid,"game.js?v=20260918-v302session4",'transport must load the current gameplay/performance bundle');
