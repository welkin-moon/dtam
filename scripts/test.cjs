...
includes(hybrid,"game.js?v=20260922-pixelanimal1",'transport must load the current session-fencing gameplay bundle');
...
includes(html,'/hybrid-transport.js?v=20260922-pixelanimal1','current transport entry must be loaded');
...
includes(hybrid,"game.js?v=20260922-pixelanimal1",'transport must load the current gameplay/performance bundle');
...
includes(src,"PIXEL_ANIMAL_KIND={fox:'fox',cat:'blackcat'",'legacy animal protocol values must map to the new pixel roster');
